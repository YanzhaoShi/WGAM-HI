...
def parse_opt():
    ...
    parser.add_argument('--input_json', type=str,
                        default="/home/ai/data/yss/data/long_annotations_clean/data.json",
                        help=' /home/ai/data/yss/data/long_annotations_clean/data.json '
                             '/home/ai/data/yss/second_work/JigsawPuzzle/scripts/long_annotations_unclean/data.json \
                              /devdata/Dataset_CT/data2077/data.json')
    parser.add_argument('--input_fc_dir', type=str, default="/home/ai/data/yss/data/yss_fc_0218_yichang/",
                        help='/home/ai/data/yss/second_work_fc_1109/ /devdata/Dataset_CT/yss_data_fc_0310/')
    parser.add_argument('--input_att_dir', type=str, default="/home/ai/data/yss/data/yss_att_0218_yichang/",
    ...
    parser.add_argument('--input_label_h5', type=str,
                        default="//home/ai/data/yss/data/long_annotations_clean/data_label.h5",
                        help='"/devdata/Dataset_CT/data2077/data_label.h5" '
                             '/home/ai/data/yss/second_work/JigsawPuzzle/scripts/long_annotations_unclean/data_label.h5'
                             '')
    parser.add_argument('--input_short_description', type=str,
                        default="/home/ai/data/yss/data/long_annotations_clean/_label_key_words_v5.npy",
    ...
    parser.add_argument('--caption_model', type=str, default="topdown",
                        help='show_tell, att2in, att2in2, adaatt, updown, stackatt, denseatt,'
                             'transformer')
    parser.add_argument('--rnn_size', type=int, default=512,
                        help='size of the rnn in number of hidden nodes in each layer')
    parser.add_argument('--num_layers', type=int, default=1,
                        help='number of layers in lthe RNN')
    ...
    parser.add_argument('--slice', type=int, default=24,
                        help='2048 for resnet, 4096 for vgg')
    parser.add_argument('--neighbor_size', type=int, default=3,
                        help='2048 for resnet, 4096 for vgg')
    parser.add_argument('--encoder_lstm_input_size', type=int, default=512,
                        help='the encoding size of each token in the vocabulary, and the image.')
    parser.add_argument('--encoder_lstm_rnn_size', type=int, default=512,
                        help='size of the rnn in number of hidden nodes in each layer')
    parser.add_argument('--encoder_lstm_num_layers', type=int, default=1,
                        help='number of layers in the RNN')
    parser.add_argument('--encoder_lstm_drop_prob_lm', type=float, default=0.5,
    ...
    parser.add_argument('--seq_per_img', type=int, default=7,
    ...
    parser.add_argument('--usle_warmup', action='store_true',
    ...
    parser.add_argument('--save_checkpoint_every', type=int, default=120,
    ...
    parser.add_argument('--checkpoint_path', type=str, default='second_work/log_my_model_0.1_att_0.1_scan',
...
def add_eval_sample_opts(parser):
    ...
    parser.add_argument('--max_length', type=int, default=39,
